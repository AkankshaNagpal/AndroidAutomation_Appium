...
public class Test2 {
	...
	@Test(priority = 1)
	public void firstYelpTest() {
		
		wait.until(
				visibilityOfElementLocated(By
						.className("android.widget.ImageButton"))).click();
		wait.until(visibilityOfElementLocated(By.name("Settings"))).click();
		wait.until(visibilityOfElementLocated(By.name("Log In"))).click();
		...
		wel.click();
		wel.sendKeys("akanksha.nagpal@sjsu.edu");
		...
		wel.sendKeys("Abc@123e");
		
		wait.until(
				visibilityOfElementLocated(By
						.id("com.yelp.android:id/activity_login_btnLogin"))).click();
